...
printMatrix(Grb,righeO, colonneO);
  for (i=0; i<righeO; i++){
       // for (j=0; j<colonne; j++){
           // if(CarUniversali[j]==1){ //estendi solo i caratteri che sono già stati resi universali
...
//1- trovo specie più vicina alla radice: è quella che nella matrice estesa ha la riga con minor numero di 1
//cioè il minor numero di operazione di attivazione e spegnimento
